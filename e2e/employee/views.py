...
def JobDetailSubmit(request):
    ...
    if user.role == "Company":
        ...
        newjob = JobDetails.objects.create(company_id=com, jobname=jobname,companyname=companyname,
                                           ...
                                           responsibilties=responsibilties,location=location,companywebsite=companywebsite,
                                           companyemail=companyemail,companycontact=companycontact,salarypackage=salarypackage,
